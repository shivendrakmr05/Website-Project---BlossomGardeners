  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="featurette" id="about">
        <img class="featurette-image img-responsive pull-right" src="images/indoor.jpeg">
        <h2 class="featurette-heading"> Indoor Gradening <span class="text-muted"></span></h2>
        <p class="lead"> Blossom Gardening decorates the interior space to feel in nature all the time.
           </p>
      </div>
