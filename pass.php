    ...
    <div class="container">
      ...
      <div class="featurette" id="services">
        ...
        <p class="lead">We provide a range of services to cater to all your gardening need.</p>
         <h3><span class="text-muted">Landscaping</span></h3>
        <h3><span class="text-muted">Terrace Gardening</span></h3>
        <h3><span class="text-muted">Indoor Gardening</span></h3>
        <h3><span class="text-muted">Lawn Mowing Services</span></h3>
      </div>
