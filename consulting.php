  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="featurette" id="about">
        <img class="featurette-image img-responsive pull-right" src="images/consulting.jpeg">
        <h2 class="featurette-heading"> Consulting <span class="text-muted"></span></h2>
        <p class="lead"> Blossom Gardening is place for getting designs and plans for transforming any space into a garden. </p>
      </div>
