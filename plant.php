  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="featurette" id="about">
        <img class="featurette-image img-responsive pull-right" src="images/plants.jpeg">
        <h2 class="featurette-heading"> Plants  <span class="text-muted"></span></h2>
        <p class="lead"> Blossom Gardening provides best quality saplings and seeds for your garden.
           </p>
      </div>
